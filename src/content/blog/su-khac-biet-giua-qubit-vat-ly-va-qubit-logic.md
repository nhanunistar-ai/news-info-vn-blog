...
### 1. Bản chất và Độ ổn định {#bản-chất-và-độ-ổn-định}
...
### 2. Tỷ lệ overhead (Chi phí phần cứng) {#tỷ-lệ-overhead-chi-phí-phần-cứng}
...
### 3. Vai trò trong lộ trình công nghệ {#vai-trò-trong-lộ-trình-công-nghệ}
...
### 4. Khả năng tính toán {#khả-năng-tính-toán}
