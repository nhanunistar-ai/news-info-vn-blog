...
Một loạt các hoạt động khai thác mỏ kiểu doanh nghiệp đã được thực hiện trên Trái Đất vào thời điểm đó do cuộc chiến giữa lực lượng **Old Empire** và **The Domain**. 
...
### 2.181 năm trước Công nguyên —MIN
...
### 1.351 trước Công nguyên \- 1.337 trước Công nguyên
...
### 850 năm trước Công nguyên —Homer
...
### 638 \- 559 năm trước Công nguyên —Solon
...
### 630 năm trước Công nguyên —Zoroaster
...
### 604 năm trước Công nguyên —Lão Tử
...
Con rắn là biểu tượng của **Old Empire**. Nó xuất hiện ở phần đầu câu chuyện sáng tạo của họ, hay như người Hy Lạp gọi là 'Sáng thế' (Genesis), và gây ra sự hủy diệt tinh thần cho những con người đầu tiên, những người được đại diện ẩn dụ bằng Adam và Eve.  
...
Đền thờ Oracle tại Delphi là một đền thờ trong mạng lưới của nhiều đền thờ sấm truyền. Mỗi đền thờ là một trung tâm truyền tin. Các giáo sĩ **Old Empire** đã chỉ định một 'vị thần' địa phương cho mỗi đền thờ. Mỗi đền thờ trong mạng lưới này được đặt tại các khoảng cách chính xác 5 độ vĩ độ tính từ thành phố thủ đô Thebes khắp vùng Địa Trung Hải cho đến tận phía bắc tới biển Baltic.

Trong thần thoại Hy Lạp, người canh giữ Đá Omphalos tại đền thờ Delphi là một nhà tiên tri tên là **Python**, con rắn. Cô ấy là một **IS-BE**, người đã bị chinh phục bởi một 'vị thần' tên là **Apollo**. Ông ta đã chôn cô ấy dưới tảng đá Omphalos. Đây là trường hợp một 'vị thần' thiết lập đền thờ của mình trên mộ của một vị thần khác. Đây là một phép ẩn dụ rất chính xác cho Lực lượng **The Domain** đã phát hiện và vô hiệu hóa mạng lưới đền thờ của **Old Empire** trên Trái Đất. Đó là một trong những đòn chí tử giáng vào Lực lượng **Old Empire** trong hệ mặt trời Trái Đất.  
### 559 năm trước Công nguyên

Sĩ quan Chỉ huy của Tiểu đoàn **The Domain** bị mất tích vào năm 5.965 trước Công nguyên đã được phát hiện và xác định vị trí bởi một đội tìm kiếm được gửi đến Trái Đất từ Lực lượng Viễn chinh **The Domain**. Ông ta đã hóa thân thành **Cyrus II** của Ba Tư trong thời gian này.
Một hệ thống tổ chức độc đáo đã được sử dụng bởi **Cyrus II** và các thành viên của Tiểu đoàn đó, những người đã theo ông từ Ấn Độ qua chuỗi các kiếp sống con người trên Trái Đất. Một phần, nó đã cho phép họ xây dựng đế chế lớn nhất trong lịch sử Trái Đất tính đến thời điểm đó.  

Đội tìm kiếm của **The Domain**, những người đã xác định vị trí của ông, đã du hành khắp Trái Đất để tìm kiếm Tiểu đoàn bị mất tích trong vài nghìn năm. Đội gồm 900 sĩ quan của **The Domain**, được chia thành các nhóm 300 người. Một nhóm tìm kiếm trên đất liền, một nhóm khác tìm kiếm trên các đại dương và nhóm thứ ba tìm kiếm không gian xung quanh Trái Đất. Có nhiều báo cáo được thực hiện trong các nền văn minh nhân loại khác nhau liên quan đến các hoạt động của họ, những điều mà con người dĩ nhiên là không hiểu được.  

Đội tìm kiếm của **The Domain** đã thiết kế một loạt các thiết bị phát hiện điện tử cần thiết để theo dõi chữ ký điện tử hoặc bước sóng của từng thành viên bị mất tích trong Tiểu đoàn. Một số được sử dụng trong không gian, số khác trên đất liền, và các thiết bị đặc biệt đã được phát minh để phát hiện các **IS-BE** dưới nước.  

Trong sự thiếu hụt các dữ liệu đầy đủ và chính xác, bất kỳ ai quan sát một hiện tượng đều sẽ giả định hoặc đưa ra các giả thuyết giải thích nhằm cố gắng hiểu được dữ liệu đó. Vì vậy, mặc dù thần thoại và lịch sử có thể dựa trên các sự kiện thực tế, nhưng chúng cũng chứa đầy những đánh giá sai lầm và diễn giải sai về dữ liệu, và được tô điểm thêm bởi các giả định, lý thuyết và giả thuyết vốn là sai lầm. 

Đơn vị không gian của Lực lượng Viễn chinh **The Domain** được hiển thị là đang bay trong một 'Đĩa có cánh' (Winged-Disc). Đây là một ám chỉ đến quyền năng tâm linh của các **IS-BE**, cũng như đối với phi thuyền không gian được sử dụng bởi Đội tìm kiếm của **The Domain**. 

Chỉ huy của Tiểu đoàn bị mất tích, với tư cách là **Cyrus II**, là một **IS-BE** được coi là một đấng cứu thế (messiah) trên Trái Đất bởi cả người Do Thái và người Hồi giáo. Trong chưa đầy 50 năm, ông đã thiết lập một tiêu chuẩn đạo đức và triết học nhân đạo cao cả bao trùm toàn bộ Văn minh phương Tây.  

Những cuộc chinh phục lãnh thổ, tổ chức con người và các dự án xây dựng tượng đài của ông là chưa từng có trước đó hoặc sau này. Những thành tựu sâu rộng như vậy trong một khoảng thời gian ngắn chỉ có thể đạt được bởi một nhà lãnh đạo và một đội ngũ gồm các sĩ quan, phi công, kỹ sư và phi hành đoàn được đào tạo của một đơn vị thuộc **The Domain**, hành động như một đội, những người đã được đào tạo và làm việc cùng nhau trong hàng nghìn năm.  

Mặc dù chúng tôi đã khám phá ra vị trí của nhiều **IS-BE** trong Tiểu đoàn bị mất tích, **The Domain** cho đến nay vẫn chưa thể khôi phục trí nhớ của họ và đưa họ trở lại nhiệm vụ hoạt động.  

Tất nhiên chúng tôi không thể vận chuyển các **IS-BE** đang trú ngụ trong các cơ thể sinh học lên trạm không gian của **The Domain** vì không có oxy trong phi thuyền của chúng tôi. Ngoài ra chúng tôi không duy trì các cơ sở hỗ trợ sự sống cho các thực thể sinh học ở đó. Hy vọng duy nhất của chúng tôi là xác định vị trí và khơi dậy lại nhận thức, trí nhớ và danh tính của các **IS-BE** trong Tiểu đoàn bị mất tích. Một ngày nào đó họ sẽ có khả năng tái gia nhập cùng chúng tôi.  
