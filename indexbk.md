...
const metadata = {
  title: 'TRANG THÔNG TIN TỔNG HỢP',
...
<Layout metadata={metadata}>
  ...
  >
    ...
    <Fragment slot="subtitle">
      <span class="hidden sm:inline">
        <span class="font-semibold">Sau hơn nửa thế kỷ,</span> nhân loại đã chính thức quay trở lại quỹ đạo Mặt Trăng.</span
      >
      <span class="block mb-1 sm:hidden font-bold text-blue-600">www.news.info.vn</span>
  ...
  <Note title="Discovery: KHÁM PHÁ VŨ TRỤ" description="" />
  ...
  >
    <Fragment slot="content">
      ...
      Xây dựng bộ não thứ hai vĩnh cửu và ngoại tuyến với sức mạnh của văn bản thuần túy.
    </Fragment>
  ...
  >
    <Fragment slot="content">
      ...
      Hệ thống quản trị tri thức tối thượng biến những mảnh ghép thông tin thành một cỗ máy tư duy sáng tạo.
    </Fragment>
